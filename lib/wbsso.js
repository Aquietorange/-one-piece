...
module.exports.sp =function(Pubkey,servertime,nonce,pass){
    let f = new sinaSSOEncoder.RSAKey;
    f.setPublic(Pubkey, "10001");
  let b = f.encrypt([servertime, nonce].join("\t") + "\n" + pass);
    return b;
}
...
/*
//获取  pubkey  nonce 地址 : https://login.sina.com.cn/sso/prelogin.php?entry=weibo&callback=sinaSSOController.preloginCallBack&su=Nzk5ODU4NTIxJTQwcXEuY29t&rsakt=mod&checkpin=1&client=ssologin.js(v1.4.19)&_=1589611228945
me.nonce=nonce
me.rsaPubkey  =pubkey
me.servertime=当前时间
 sp=b 
